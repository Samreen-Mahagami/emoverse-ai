                    ...
                    with st.spinner("📖 Analyzing your uploaded content..."):
                        try:
                            ...
                            with st.spinner("🎯 Generating lesson plan from your content..."):
                                ...
                                # Debug: Check if lesson plan generation worked
                                if not lesson_plan:
                                    st.warning("⚠️ AI generation failed, using fallback method...")
...
"""
    ...
    if activities:
        ...
        st.markdown("• No activities found - check lesson plan generation")
