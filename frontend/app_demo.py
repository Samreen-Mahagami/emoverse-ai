...
<style>
    ...
    .stApp {
        background: linear-gradient(135deg, #9575CD 0%, #81C784 25%, #FFB74D 50%, #9575CD 75%, #81C784 100%);
    ...
    * {
    ...
    .stApp {
        background: linear-gradient(135deg, #9575CD 0%, #81C784 25%, #FFB74D 50%, #9575CD 75%, #81C784 100%) !important;
    ...
    .stFileUploader > div > div > div > div {
        ...
        border: 3px dashed #9575CD !important;
    ...
    .stTextInput input:focus {
        ...
        box-shadow: 0 0 10px rgba(149, 117, 205, 0.3) !important;
    }
    ...
    [data-testid="stSidebar"] {
        background: linear-gradient(180deg, #9575CD 0%, #81C784 100%);
    ...
    [data-testid="stExpander"] {
        border: 2px solid rgba(149, 117, 205, 0.3) !important;
        border-radius: 12px !important;
        margin: 20px 0 !important;
    ...
    .stProgress > div > div > div {
        background: linear-gradient(90deg, #9575CD 0%, #81C784 100%);
    }
