...
st.markdown("""
<style>
    /* Main background with gradient - Nature Theme: Sage Green → Yellow → Teal → Green → Yellow */
    .stApp {
        background: linear-gradient(135deg, #8FBC8F 0%, #F0E68C 25%, #20B2AA 50%, #7CB342 75%, #F0E68C 100%);
    ...
    * {
    ...
    .stApp {
        background: linear-gradient(135deg, #8FBC8F 0%, #F0E68C 25%, #20B2AA 50%, #7CB342 75%, #F0E68C 100%) !important;
    ...
    [data-testid="stSidebar"] {
        background: linear-gradient(180deg, #7CB342 0%, #20B2AA 100%);
    ...
    .stButton > button {
        background: linear-gradient(135deg, #7CB342 0%, #F0E68C 100%);
        color: white;
        border: none;
        border-radius: 8px;
        padding: 16px 32px;
    ...
    .stButton > button[kind="primary"] {
        background: linear-gradient(135deg, #7CB342 0%, #F0E68C 100%) !important;
    }
    ...
    .stTabs [aria-selected="true"] {
        background: linear-gradient(135deg, #7CB342 0%, #20B2AA 100%);
        color: white !important;
    }
...
READING & DISCUSSION ({plan.get('phases', {}).get('reading_discussion', plan.get('phases', {}).get('main_activity', {})).get('duration_minutes', 0)} minutes):
{chr(10).join('├─ ' + act for act in plan.get('phases', {}).get('reading_discussion', plan.get('phases', {}).get('main_activity', {})).get('activities', []))}

PRACTICE ACTIVITY ({plan.get('phases', {}).get('practice_activity', plan.get('phases', {}).get('extension', {})).get('duration_minutes', 0)} minutes):
{chr(10).join('├─ ' + act for act in plan.get('phases', {}).get('practice_activity', plan.get('phases', {}).get('extension', {})).get('activities', []))}

WRAP-UP ({plan.get('phases', {}).get('wrap_up', plan.get('phases', {}).get('assessment', {})).get('duration_minutes', 0)} minutes):
{chr(10).join('├─ ' + method for method in plan.get('phases', {}).get('wrap_up', plan.get('phases', {}).get('assessment', {})).get('methods', plan.get('phases', {}).get('wrap_up', plan.get('phases', {}).get('assessment', {})).get('activities', [])))}
